...
<html lang="en">
  ...
  <body>
          ...
          <div class="row">
            <div class="col-2">
              <div class="form-check">
                <input type="radio" class="form-check-input" name="map_type" value="basic" checked>
                <label class="form-check-label" for="radio1">Basic</label>
              </div>
            </div>
            <div class="col-2">
              <div class="form-check">
                <input type="radio" class="form-check-input" name="map_type" value="bright" >
                <label class="form-check-label" for="radio1">Bright</label>
              </div>
            </div>
            <div class="col-2">
              <div class="form-check">
                <input type="radio" class="form-check-input" name="map_type" value="satellite_hybrid" >
                <label class="form-check-label" for="radio1">Satellite Hybrid</label>
              </div>
            </div>
            <div class="col-2">
              <div class="form-check">
                <input type="radio" class="form-check-input" name="map_type" value="street" >
                <label class="form-check-label" for="radio1">Streets</label>
              </div>
            </div>
            <div class="col-2">
              <div class="form-check">
                <input type="radio" class="form-check-input" name="map_type" value="topo" >
                <label class="form-check-label" for="radio1">Topo</label>
              </div>
            </div>
          </div> 
        </div>
    ...
    <script>
      ...
      var baseUrl = `http://localhost:3650/api/maps/basic/style.json`  /* Local maptiler server's vector style url*/
      ...
      function changeMapType(type) { /*This function is used change map type for fetched locations*/
        ...
        switch (type) { /*Based on type base url of server api will change*/
          case 'basic':
            baseUrl = `http://localhost:3650/api/maps/basic/style.json` ;
            break;
          case 'bright':
            baseUrl = `http://localhost:3650/api/maps/bright/style.json` ;
            break;
          case 'satellite_hybrid':
            baseUrl = `http://localhost:3650/api/maps/satellite-hybrid/style.json` ;
            break;
          case 'street':
            baseUrl = `http://localhost:3650/api/maps/streets/style.json` ;
            break;
          case 'topo':
            baseUrl = `http://localhost:3650/api/maps/topo/style.json` ;
            break;
        }
